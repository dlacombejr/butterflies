...
% M=makemask(rand(neurons,batch_size),5);
...
%         
%         if j >100
%                     a=blocksparse_vec(a,15);
%                     a=blocksparse_vec(a,10);
%                     a=blocksparse_vec(a,5);
                    M=makemask(a,5);
                    a=blockmask(a,M);
%                     a=blocksparse_vec(a,3);
%         end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function M=makemask(X,blocksize)

n=sqrt(size(X,1));

B = im2col(reshape(1:n^2,[n n])',[blocksize blocksize]);

M=zeros(size(B,2),size(X,1));
